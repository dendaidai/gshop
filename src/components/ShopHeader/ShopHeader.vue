<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleSupportShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleShopShow">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="supportShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toggleSupportShow">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="shopShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="toggleShopShow">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
